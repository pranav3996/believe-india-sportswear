        ...
        const emailHtml = `
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        <h2>Hi ${name},</h2>
                        <p>We received a request to reset your password for your Believe India Sportswear account.</p>
                        ...
                        <div class="warning">
                            <strong>⏰ Important:</strong> This password reset link will expire in <strong>10 minutes</strong>. Please reset your password as soon as possible.
                        </div>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>This is a confirmation that your Believe India Sportswear account password was changed.</p>
                        ...
                        <div style="text-align: center;">
                            <a href="${process.env.NEXTAUTH_URL || 'http://localhost:3000'}/login" class="button">Login to Your Account</a>
                        </div>
                    </div>
                    <div class="footer">
                        <p>© ${new Date().getFullYear()} Believe India Sportswear. All rights reserved.</p>
